...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20, paddingBottom: 32 }}>
      ...
      <SettingsCard delay={0.02} gradient="linear-gradient(135deg, rgba(13,97,127,0.10), rgba(46,186,154,0.08))">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
          <div style={{ border: '1px solid rgba(31,184,167,0.22)', borderRadius: 12, padding: 12, background: 'rgba(255,255,255,0.82)' }}>
