...
export const ParentNav: React.FC<Props> = React.memo(({ active, onNavigate }) => {
  ...
  <>
    ...
    >
      ...
      {/* Bottom status */}
      <div style={{
        marginTop: 'auto', paddingTop: 12, paddingBottom: 18,
        ...
        <div style={{
          ...
          />
          <p style={{ fontSize: 10, fontWeight: 800, color: '#3A3F9F', margin: 0, letterSpacing: '0.08em' }}>LIVE STATUS</p>
          <span
            style={{
              marginLeft: 'auto',
              fontSize: 9,
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 600, color: '#7A86C2' }}>Last activity</span>
            <span style={{ fontSize: 10, fontWeight: 700, color: '#3A3F9F', textAlign: 'right' }}>{liveMonitoring.lastSession}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10 }}>
            <span style={{ fontSize: 10, fontWeight: 600, color: '#7A86C2' }}>Recent session</span>
            <span style={{ fontSize: 10, fontWeight: 700, color: '#3A3F9F', textAlign: 'right' }}>{liveMonitoring.sessionLength}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, alignItems: 'flex-start' }}>
            <span style={{ fontSize: 10, fontWeight: 600, color: '#7A86C2' }}>Current activity</span>
            <span style={{ fontSize: 10, fontWeight: 700, color: '#6366F1', textAlign: 'right', maxWidth: 118, lineHeight: 1.35 }}>
