...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'books',       label: 'Books',          sublabel: 'Learning Library', icon: '📚', gradient: 'from-pink-400 to-violet-500', glowColor: 'rgba(236,72,153,0.20)',  accentColor: '#ec4899', iconBg: 'rgba(236,72,153,0.10)' },
