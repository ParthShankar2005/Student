...
const modalCopy = {
  badge: 'Learning Family Pass',
  title: 'Enter Parent Learning Key',
  description: 'Confirm family access to open the Std 4 parent learning dashboard for',
  label: 'Parent Learning Key',
  placeholder: 'Enter learning key',
  helper: 'Use this family key to move from the student learning dashboard to the parent view.',
  submit: 'Open Parent Learning View',
};
