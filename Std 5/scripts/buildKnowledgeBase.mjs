 ...
 * ================================
 * Parses "English Class 5.pdf" and "Mathematics Class 5.pdf"
...
// ─── Configuration ────────────────────────────────────────
const PDF_FILES = [
  { file: 'English Class 5.pdf', subject: 'English', skipPages: 12 },
  { file: 'Mathematics Class 5.pdf', subject: 'Math', skipPages: 12 },
];
 ...
 *   - English Class 5.pdf  (${allChunks.filter(c => c.subject === 'English').length} chunks)
 *   - Mathematics Class 5.pdf  (${allChunks.filter(c => c.subject === 'Math').length} chunks)
 */
