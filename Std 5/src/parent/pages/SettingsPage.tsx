...
export const SettingsPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20, paddingBottom: 32 }}>
      ...
      <SettingsCard delay={0.02} gradient="linear-gradient(135deg, rgba(63,143,58,0.10), rgba(127,174,101,0.08))">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 10 }}>
          <div style={{ border: '1px solid rgba(63,143,58,0.16)', borderRadius: 12, padding: 12, background: 'rgba(255,255,255,0.8)' }}>
